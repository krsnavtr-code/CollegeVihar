...
<style>
    ...
    .blog-card .text-box {
        ...
        background: linear-gradient(180deg, rgba(255, 255, 255, 0.6) 0%, rgba(0, 0, 0, 0.4) 100%);
    } 
    */
</style>
@endpush
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-6 p-2">
                        <a class="card blog-card" href="{{ url( $blog['metadata']['url_slug']) }}">
                            ...
                            <img src="{{url('images/blogs/' . $blog['blog_pic'])}}" style='height: 250px;  width: 370px;'    alt="Blog Image" 
                ...
                <aside class="sidebar">
                    ...
                    <div class="card mb-2">
                        <a class="side-card" href="{{ url($reb['metadata']['url_slug']) }}">
                            <img class="img-fluid rounded" src="{{ url('images/blogs/' . $reb['blog_pic']) }}" alt="" width="100" onerror="this.onerror=null; this.src='{{ url('images/blogs/blog.png') }}';">
                            <div class="">
