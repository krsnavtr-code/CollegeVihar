                                ...
                                <div class="row align-items-center text-sm-start text-center">
                                    <div class="col-sm-8">
                                        <div class="text-box mt-2">
                                            ...
                                            <h5 class="display-6">With Our Award Winning Guru's</h5>
                                ...
                                <div class="row align-items-center text-sm-start text-center">
                                    <div class="col-sm-8">
                                        <div class="text-box mt-2">
                                            ...
                                            <h2 class="display-5">Your path to reputable degrees anytime from anywhere
                                                <a href="tel:+919266585858" class="btn btn-light"> call us: +91-9266585858</a>
                                            </h2>

                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <img src="https://collegevihar.com/images/slider/slide_2.webp" alt="" class="img-fulid"
                                            style="height: 13rem;width: 12rem;" />
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="row align-items-center text-sm-start text-center">
                                    <div class="col-sm-8 mt-4">
                                        <div class="text-box mt-2">
                                            <h5> Get The Best Jobs</h5> {{-- Explore a world of knowledge --}}
                                            <h2 class="display-5">From Top MNC's</h2>
                                            {{--you are one click away --}}
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <img src="https://collegevihar.com/images/slider/slide_3.webp" alt="" class="img-fulid"
                                            style="height: 13rem; width:12rem" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row align-items-center text-sm-start text-center">
                                    <div class="col-sm-8 mt-4">
                                        <div class="text-box mt-2">
                                            ...
                                            <h2 class="display-5"> Deserving Student</h2> {{--services to simplify--}}
                                            <h5> Get All Information Regarding Scholarship Programs At One Place</h5> {{--your path
                                            to success--}}
                                        </div>
                                    </div>
                        ...
                        <div class="row justify-content-center g-3">
                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3" style="max-width: 70vw;">
                                <div class="card shadow-lg border-3 border-primary rounded-4 home-program-card"
                                    style="max-width: 300px;">
                                    <a href="/scholarship">
                                        <img src="/images/home/scholarship.png" alt="scholarship" class="img-fluid w-100 shadow-lg"
                                            style="height: 17vh">
                                        <button class="btn btn-danger w-100"
                                            style="border-bottom-left-radius: 12px; border-bottom-right-radius: 12px;">
                                            Scholarship Exams
                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3 " style="max-width: 70vw;">
                                            <div class="card shadow-lg border-3 border-primary rounded-4 home-program-card" style="max-width: 300px;">
                                                <a data-bs-toggle="modal" data-bs-target="#callbackModal">
                                                    <img src="/images/home/call.png" alt="call" class="img-fluid w-100 shadow-lg" style="height: 17vh">
                                                    <button class="btn btn-danger w-100" data-bs-toggle="modal" data-bs-target="#callbackModal"
                                                        style="border-bottom-left-radius: 12px; border-bottom-right-radius: 12px;">
                                                        Request a Callback
                                                    </button>
                                                </a>
                            ...
                            <!-- recommend end--> 
                            {{-- <section class="bg-blue p-2" id="counter">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-4 p-2">
                                ...
                                <div class="container">
                                    <div class="row align-items-center">
                                        <div class="col-sm-8 p-2">
                                            ...
                                            <p>Collegevihar is an online learning platform that makes it simple for students to get enrolled in
                                                top
                                                colleges, based on their location or financial situation. Collegevihar assists students in
                                                achieving
                                                their academic objectives and creating a better future by providing flexible learning options,
                                ...
                                <div class="container">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 p-2">
                                            ...
                                            <p class="mb-2">Explore our programs, partner universities, and tuition rates with ease. Let us help
