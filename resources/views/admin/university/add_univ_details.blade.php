...
@section('main')
    <main>
        ...
        <!-- University URL slug -->
        <form id="slugForm" action="{{ route('admin.university.add.details.update.slug') }}" method="post"
            class="section-form">
            @csrf
                    ...
                    @foreach($descriptions as $index => $desc)
                        <div class="field cflex">
                            ...
                            <div class="field-wrapper">
                                <textarea oninput="auto_grow(this)" id="desc_{{ $index + 1 }}" name="univ_description[]"
        ...
        <!-- Overview -->
        <form id="overviewForm" action="{{ route('admin.university.add.details.update.overview') }}" method="post"
            class="section-form">
            @csrf
            <input type="hidden" name="univ_id" value="{{ $university['id'] }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="field cflex">
                            ...
                            <input type="number" id="univ_campus_area" name="univ_campus_area" class="form-control"
                                placeholder="Enter campus area in acres"
                    ...
                    <div class="col-md-6">
                        <div class="field cflex">
                            ...
                            <input type="text" id="univ_courses_offered" name="univ_courses_offered" class="form-control"
                                placeholder="e.g., B.Tech, MBA, BBA, BCA"
        ...
        <form id="popularCoursesForm" action="{{ route('admin.university.add.details.update.popular-courses') }}"
            method="post" class="section-form mb-4">
            @csrf
            <input type="hidden" name="univ_id" value="{{ $university['id'] }}">
                            ...
                            <div class="program-entry mb-3 p-3 border rounded">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="undergrad_programs[{{ $index }}][program]" class="form-control"
                                            placeholder="e.g., B.Tech"
                                            value="{{ old('undergrad_programs.' . $index . '.program', $program['program'] ?? '') }}"
                                            required>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="undergrad_programs[{{ $index }}][duration]"
                                            ...
                                            value="{{ old('undergrad_programs.' . $index . '.duration', $program['duration'] ?? '') }}"
                                            required>
                                    </div>
                                    <div class="col-md-4">
                        ...
                        @foreach(($popularCourses['postgraduate'] ?? [['program' => '', 'duration' => '', 'specializations' => '']]) as $index => $program)
                            <div class="program-entry mb-3 p-3 border rounded">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label>Program Name</label>
                                        <input type="text" name="postgrad_programs[{{ $index }}][program]" class="form-control"
                                            placeholder="e.g., M.Tech"
                                            value="{{ old('postgrad_programs.' . $index . '.program', $program['program'] ?? '') }}"
                                            required>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Duration</label>
                                        <input type="text" name="postgrad_programs[{{ $index }}][duration]" class="form-control"
                                            placeholder="e.g., 2 years"
                                            value="{{ old('postgrad_programs.' . $index . '.duration', $program['duration'] ?? '') }}"
                                            required>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Specializations</label>
                        ...
                        @foreach(($popularCourses['diploma'] ?? [['program' => '', 'duration' => '', 'specializations' => '']]) as $index => $program)
                            <div class="program-entry mb-3 p-3 border rounded">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label>Program Name</label>
                                        <input type="text" name="diploma_programs[{{ $index }}][program]" class="form-control"
                                            placeholder="e.g., Diploma in Engineering"
                                            value="{{ old('diploma_programs.' . $index . '.program', $program['program'] ?? '') }}"
                                            required>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Duration</label>
                                        <input type="text" name="diploma_programs[{{ $index }}][duration]" class="form-control"
                                            placeholder="e.g., 3 years"
                                            value="{{ old('diploma_programs.' . $index . '.duration', $program['duration'] ?? '') }}"
                                            required>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Specializations</label>
                        ...
                        @foreach(($popularCourses['others'] ?? [['program' => '', 'duration' => '', 'specializations' => '']]) as $index => $program)
                            <div class="program-entry mb-3 p-3 border rounded">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label>Program Name</label>
                                        <input type="text" name="other_programs[{{ $index }}][program]" class="form-control"
                                            placeholder="e.g., Certificate Course"
                                            value="{{ old('other_programs.' . $index . '.program', $program['program'] ?? '') }}"
                                            required>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Duration</label>
                                        <input type="text" name="other_programs[{{ $index }}][duration]" class="form-control"
                                            placeholder="e.g., 6 months"
                                            value="{{ old('other_programs.' . $index . '.duration', $program['duration'] ?? '') }}"
                                            required>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Specializations</label>
        ...
        <!-- Admission Process -->
        <form id="admissionProcessForm" action="{{ route('admin.university.add.details.update.admission') }}" method="post"
            class="section-form mb-4">
            @csrf
            <input type="hidden" name="univ_id" value="{{ $university['id'] }}">
            ...
            <section class="panel" data-name="univ_admission" data-label="Admission Process">
                ...
                <div class="form-group">
                    ...
                    <textarea name="univ_admission" id="univ_admission" class="form-control rich-text-editor" rows="10"
                        placeholder="Enter detailed admission process information here...">{{ old('univ_admission', $university['univ_admission'] ?? '') }}</textarea>
                    <small class="form-text text-muted">
                        Provide detailed information about the admission process, requirements, important dates, and any
        ...
        <form id="eligibilityForm" action="{{ route('admin.university.add.details.update.eligibility') }}" method="post"
            class="section-form">
            @csrf
            <input type="hidden" name="univ_id" value="{{ $university['id'] }}">
            ...
            <section class="panel" data-name="univ_eligibility" data-label="Admission Eligibility">
                ...
                <div class="form-group">
                            ...
                            <div class="eligibility-criteria-item mb-3 p-3 border rounded">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="eligibility[{{ $index }}][course]" class="form-control"
                                            placeholder="e.g., 10th, 12th, B.Tech, BBA" value="{{ $criteria['course'] ?? '' }}"
                                            required>
                                    </div>
                                    <div class="col-md-4">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <textarea name="eligibility_notes" id="eligibility_notes" class="form-control" rows="3"
                            placeholder="Any additional notes or special conditions...">{{ old('eligibility_notes', $eligibilityNotes ?? '') }}</textarea>
                    </div>

                    <small class="form-text text-muted">
                        Add all relevant eligibility criteria with minimum percentage requirements. Click "Add Another
                        Criteria" to include multiple requirements.
                    </small>
            </section>
        </form>

        <!-- Important Dates (Tentative) -->
        <form id="importantDatesForm" action="{{ route('university.update.important_dates') }}" method="post"
            class="section-form">
            @csrf
            <input type="hidden" name="univ_id" value="{{ $university['id'] }}">
            ...
            <section class="panel" data-name="important_dates" data-label="Important Dates (Tentative)">
                ...
                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="important_dates[{{ $index }}][date]" id="date_{{ $index }}"
                                                    class="form-control"
                                                    value="{{ old('important_dates.' . $index . '.date', $date['date'] ?? '') }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                    ...
                    <div class="form-group mt-4">
                        ...
                        <textarea name="important_dates_notes" id="important_dates_notes" class="form-control" rows="3"
        ...
        <!-- Placement Details -->
        <form id="placementForm" action="{{ route('admin.university.add.details.update.placement') }}" method="post"
            class="section-form">
            @csrf
            <input type="hidden" name="univ_id" value="{{ $university['id'] }}">
                    ...
                    <div id="recruiters-container">
                        ...
                        @foreach($recruiters as $index => $recruiter)
                            <div class="recruiter-item input-group mb-2">
                                <input type="text" name="recruiters[]" class="form-control" value="{{ $recruiter }}"
        ...
        <!-- University Facts -->
        <form id="factsForm" action="{{ route('admin.university.add.details.update.facts') }}" method="post"
            class="section-form">
            @csrf
            <input type="hidden" name="univ_id" value="{{ $university['id'] }}">
            <div class="section-header">
                    ...
                    @foreach($savedFacts as $index => $fact)
                        <div class="field cflex">
                            ...
                            <div class="d-flex align-items-center">
                                <textarea oninput="auto_grow(this)" id="univ_facts{{ $index }}" name="univ_facts[]"
                                    placeholder="Write Here...">{{ is_array($fact) ? ($fact['fact'] ?? '') : $fact }}</textarea>
                                <button type="button" class="btn btn-sm btn-danger ms-2" onclick="removeField(this)" {{ $factCount <= 1 ? 'disabled' : '' }}>
                                    <i class="fas fa-times"></i>
                                </button>
                            </div>
                        </div>
        ...
        <form id="advantagesForm" action="{{ route('admin.university.add.details.update.advantages') }}" method="post"
            class="section-form" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="univ_id" value="{{ $university['id'] }}">
            <div class="section-header">
            ...
            <section class="panel" data-name="univ_advantages" data-label="Advantages">
                ...
                <div class="field cflex">
                    ...
                    <input type="text" name="univ_adv[about]" placeholder="University Advantage About"
                        value="{{ $university['univ_advantage'] ? json_decode($university['univ_advantage'], true)['about'] ?? '' : '' }}">
                </div>
                            ...
                            <div class="field_group">
                                <div class="field aie" style="width:auto;">
                                    <label for="advl_{{ $index }}" class="logo">
                                        <img src="{{ asset('images/university/advantages/' . ($advantage['logo'] ?? '')) }}"
                                            alt="Advantage Logo">
                                    </label>
                                    <input type="file" id="advl_{{ $index }}" name="univ_adv[data][{{ $index }}][logo]"
                                        placeholder="University Advantage Logo" onchange="display_pic(this)">
                                </div>
                                <div class="field cflex">
                                    <label for="advt_{{ $index }}">Advantage Title</label>
                                    <input type="text" id="advt_{{ $index }}" name="univ_adv[data][{{ $index }}][title]"
                                        placeholder="University Advantage" value="{{ $advantage['title'] ?? '' }}">
                                </div>
                                <div class="field cflex">
                                    <label for="advd_{{ $index }}">Advantage Description</label>
                                    <input type="text" id="advd_{{ $index }}" name="univ_adv[data][{{ $index }}][description]"
                                        placeholder="University Advantage Description"
                ...
                <i class="icon fa-solid fa-plus add_field"
                    ...
                    data-target="#advantages-container"></i>
            </section>
        </form>

        <!-- University Industry-Ready Programs -->
        <form id="industryForm" action="{{ route('admin.university.add.details.update.industry') }}" method="post"
            class="section-form">
            @csrf
            <input type="hidden" name="univ_id" value="{{ $university['id'] }}">
            <div class="section-header">
            ...
            <section class="panel" data-name="univ_industry" data-label="Industry-Ready Programs">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="section_title">Industry-Ready Programs for Enhanced Career Readiness:
                        {{ $university['univ_name'] }}</h3>
                    ...
                    @if($university['univ_industry'] && isset(json_decode($university['univ_industry'], true)['data']))
                        @foreach(json_decode($university['univ_industry'], true)['data'] ?? [] as $index => $industry)
                            <div class="field cflex">
                                ...
                                <input id="ind_{{ $index }}" name="industry[data][]" placeholder="Industry Point"
                                    value="{{ $industry }}" />
                                <i class="icon fa-solid fa-trash remove-field" onclick="removeField(this)"></i>
                            </div>
                        @endforeach
                ...
                <i class="icon fa-solid fa-plus add_field"
                    data-field='<div class="field cflex"><label for="ind__id__">Industry __id__</label><input id="ind__id__" name="industry[data][]" placeholder="Industry Point" /><i class="icon fa-solid fa-trash remove-field" onclick="removeField(this)"></i></div>'
                    data-target="#industry-container"></i>
            </section>
        </form>

        <!-- University Career Guidance -->
        <form id="careerGuidanceForm" action="{{ route('admin.university.add.details.update.career-guidance') }}"
            ...
            <section class="panel" data-name="univ_career_guidance" data-label="Career Guidance">
                ...
                <div class="field cflex">
                    ...
                    <input type="text" id="car" name="carrier[about]" placeholder="About Career"
                        value="{{ $university['univ_career_guidance'] ? json_decode($university['univ_career_guidance'], true)['about'] ?? '' : '' }}">
                </div>
                    ...
                    @if($university['univ_career_guidance'] && isset(json_decode($university['univ_career_guidance'], true)['data']))
                        @foreach(json_decode($university['univ_career_guidance'], true)['data'] as $index => $career)
                            <div class="field cflex">
                                ...
                                <input type="text" id="car_{{ $index }}" name="carrier[data][]" placeholder="Career"
                                    value="{{ $career }}">
                                <i class="icon fa-solid fa-trash remove-field" onclick="removeField(this)"></i>
                            </div>
                        @endforeach
                ...
                <i class="icon fa-solid fa-plus add_field"
                    data-field='<div class="field cflex"><label for="car__id__">Career __id__</label><input type="text" id="car__id__" name="carrier[data][]" placeholder="Career"><i class="icon fa-solid fa-trash remove-field" onclick="removeField(this)"></i></div>'
                    data-target="#career-container"></i>
            </section>
        </form>

        <!-- University SEO Work -->
        <form id="seoForm" action="{{ route('admin.university.add.details.update.seo') }}" method="post"
            class="section-form">
            @csrf
            <input type="hidden" name="univ_id" value="{{ $university['id'] }}">
            <div class="section-header">
            ...
            @if(session('section') === 'seo')
                <div class="alert alert-{{ session('error') ? 'danger' : 'success' }}">
                    {{ session('error') ?? session('message', 'SEO information updated successfully!') }}
                </div>
            @endif
            <section class="panel">
                ...
                <div class="field cflex">
                    ...
                    <input type="text" id="meta_h1" name="meta_h1" placeholder="H1 Tag"
                        value="{{ old('meta_h1', $university->univ_meta_h1 ?? '') }}">
                </div>
                <div class="field_group">
                    <div class="field cflex">
                        <label for="meta_title">Meta Title of Page</label>
                        <input type="text" id="meta_title" name="meta_title" placeholder="Meta Title"
                            value="{{ old('meta_title', $university->univ_meta_title ?? '') }}" maxlength="255">
                    </div>
                    <div class="field cflex">
                        ...
                        <input type="text" id="meta_description" name="meta_description" placeholder="Meta Description"
                            value="{{ old('meta_description', $university->univ_meta_description ?? '') }}" maxlength="500">
                    </div>
                </div>
                <div class="field cflex">
                    <label for="meta_key">Meta Keywords of Page (key1, key2, key3)</label>
                    <input type="text" id="meta_key" name="meta_keywords" placeholder="Meta Keywords"
                        value="{{ old('meta_keywords', $university->univ_meta_keywords ?? '') }}" maxlength="500">
                </div>
                <div class="field cflex">
                    <label for="meta_canonical">Canonical URL</label>
                    <input type="url" id="meta_canonical" name="meta_canonical" placeholder="https://example.com/page"
                        value="{{ old('meta_canonical', $university->univ_meta_canonical ?? '') }}">
                </div>
                <div class="text-right" style="margin: 1rem 0;">
                    <button type="submit" class="btn-save">Save SEO Settings</button>
                </div>
        ...
        <form id="visibilityForm" action="{{ route('admin.university.add.details.update.visibility') }}" method="post" class="section-form">
            @csrf
            <input type="hidden" name="univ_id" value="{{ $university['id'] }}">
            <section class="panel">
                <h3 class="section_title">University Visibility</h3>
                <div class="field">
                    <input type="checkbox" name="univ_detail_added" id="univ_detail_added" value="1" 
                        {{ old('univ_detail_added', $university->univ_detail_added ?? 0) ? 'checked' : '' }}>
                    <label for="univ_detail_added">Show on frontend</label>
                </div>
                <div class="text-right" style="margin: 1rem 0;">
                    <button type="submit" class="btn-save">Update Visibility</button>
                </div>
            </section>
        </form>
    </main>
