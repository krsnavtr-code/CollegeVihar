...
@section('title', 'Add Course Details - CV Admin')

@section('main')
    <main>
        @include('admin.components.response')
        <form action="/admin/course/add/details" method="post">
            <h2 class="page_title">Add Course Details </h2>
            @csrf
            <section class="panel">
            ...
            <section class="panel">
                ...
                <i class="icon fa-solid fa-plus add_field"
                    data-field='<div class="field_group head_field"><div class="field"><label for="int__id__">Paragraph __id__</label><textarea id="int__id__" name="course_intro[]" placeholder="Write Here..."></textarea></div><i class="icon delete fa-solid fa-trash" onclick="delete_field(this)"></i></div>'></i>
            </section>
            <section class="panel">
                <h3 class="section_title">Course Overview</h3>
                <i class="icon fa-solid fa-plus add_field"
                    data-field='<div class="field_group head_field"><div class="field"><label for="over__id__">Paragraph __id__</label><textarea id="over__id__" name="course_overview[]" placeholder="Write Here..."></textarea></div><i class="icon delete fa-solid fa-trash" onclick="delete_field(this)"></i></div>'></i>
            </section>
            <section class="panel">
                <h3 class="section_title">Course Heighlights</h3>
                <i class="icon fa-solid fa-plus add_field"
                    data-field='<div class="field_group head_field"><div class="field"><label for="highti__id__">Highlight Title</label><input type="text" id="highti__id__" name="course_highlights[__id__][title]" placeholder="Title"></div><div class="field"><label for="highde__id__">Highlight Description</label><input type="text" id="highde__id__" name="course_highlights[__id__][desc]" placeholder="Description"></div><i class="icon delete fa-solid fa-trash" onclick="delete_field(this)"></i></div>'></i>
            </section>
            <section class="panel">
                ...
                <i class="icon fa-solid fa-plus add_field"
                    data-field='<div class="field_group head_field"><div class="field"><label for="cou__id__">Subject __id__</label><input type="text" id="cou__id__" name="course_subjects[data][]" placeholder="Subject"></div><i class="icon delete fa-solid fa-trash" onclick="delete_field(this)"></i></div>'></i>
            </section>
            <section class="panel">
                ...
                <i class="icon fa-solid fa-plus add_field"
                    data-field='<div class="field_group head_field"><div class="field"><label for="eli__id__">Eligibilty</label><input type="text" id="eli__id__" name="course_eligibility[data][]" placeholder="Title"></div><i class="icon delete fa-solid fa-trash" onclick="delete_field(this)"></i></div>'></i>
            </section>
            <section class="panel">
            ...
            <section class="panel">
                ...
                <i class="icon fa-solid fa-plus add_field"
                    data-field='<div class="field_group head_field"><div class="field"><label for="spe__id__">Specialization __id__</label><input type="text" id="spe__id__" name="course_specialization[data][]" placeholder="Specialization"></div><i class="icon delete fa-solid fa-trash" onclick="delete_field(this)"></i></div>'></i>
            </section>
            <section class="panel">
                ...
                <i class="icon fa-solid fa-plus add_field"
                    data-field='<div class="field_group head_field"><div class="field"><label for="opp__id__">Opportunity __id__</label><input type="text" id="opp__id__" name="course_job[data][]" placeholder="Opportunity"></div><i class="icon delete fa-solid fa-trash" onclick="delete_field(this)"></i></div>'></i>
            </section>
            <section class="panel">
                <h3 class="section_title">Types of Course</h3>
                <i class="icon fa-solid fa-plus add_field"
                    data-field='<div class="field_group head_field"><div class="field"><label for="cort__id__">Course Type Title</label><input type="text" id="cort__id__" name="course_type[__id__][title]" placeholder="Title"></div><div class="field"><label for="cord__id__">Course Type Description</label><input type="text" id="cord__id__" name="course_type[__id__][desc]" placeholder="Description"></div><i class="icon delete fa-solid fa-trash" onclick="delete_field(this)"></i></div>'></i>
            </section>
            <section class="panel">
                <h3 class="section_title">Why this Course</h3>
                <i class="icon fa-solid fa-plus add_field"
                    data-field='<div class="field_group head_field"><div class="field"><label for="why__id__">Paragraph __id__</label><textarea id="why__id__" name="why_this_course[]" placeholder="Write Here..."></textarea></div><i class="icon delete fa-solid fa-trash" onclick="delete_field(this)"></i></div>'></i>
            </section>
            <section class="panel">
                <h3 class="section_title">Faqs</h3>
                <i class="icon fa-solid fa-plus add_field"
                    data-field='<div class="field_group head_field"><div class="field"><label for="faqg__id__">Faq Question</label><input type="text" id="faqg__id__" name="faq[__id__][question]" placeholder="Question"></div><div class="field"><label for="faqa__id__">Faq Question</label><input type="text" id="faqa__id__" name="faq[__id__][answer]" placeholder="Answer"></div><i class="icon delete fa-solid fa-trash" onclick="delete_field(this)"></i></div></div>'></i>
            </section>
            <section class="panel">
            ...
            <div class="text-end p-4">
                <button type="submit" class="btn btn-primary btn-lg">Add Course Details</button>
            </div>
        </form>
    </main>
    @push('script')
